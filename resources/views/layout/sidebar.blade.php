  ...
  <ul class="nav">
    <!-- <li class="nav-item nav-profile not-navigation-link">
      <div class="nav-link">
        ...
        <button class="btn btn-primary btn-block">New Project <i class="mdi mdi-plus"></i>
        </button>
      </div>
    </li> -->
    ...
    @if(auth()->user()->hasRole('administrator'))
      <li class="nav-item {{ active_class(['machines*']) }}">
        <a class="nav-link" href="{{ url('machines') }}">
          <i class="menu-icon mdi mdi-circular-saw"></i>
    ...
    @if(auth()->user()->hasRole('administrator','floor_manager'))
      <li class="nav-item {{ active_class(['floor-operations*']) }}">
        <a class="nav-link" href="{{ url('floor-operations') }}">
          <i class="menu-icon mdi mdi-hand-saw"></i>
          <span class="menu-title">Floor Operations</span>
        </a>
      </li>
    @endif

    @if(auth()->user()->hasRole('administrator','account'))
      <li class="nav-item {{ active_class(['accountings*']) }}">
        <a class="nav-link" href="{{ url('accountings') }}">
