@csrf
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" min="0" class="form-control" id="phone" name="phone" placeholder="Contact Number" value="{{$user->profile->phone ?? ''}}">
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" min="0" class="form-control" id="em_contact_number" name="em_contact_number" value="{{$user->profile->em_contact_number ?? ''}}" placeholder="Contact Number">
    </div>

    <div class="form-group col-md-6 vehicle-input" style="display:{{isset($user) && $user->roles->first()->slug == 'driver' ? 'block' : 'none'}};">
