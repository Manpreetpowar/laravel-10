@csrf
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" min="0" class="form-control" id="poc_contact" name="poc_contact" placeholder="POC Contact" value="{{$client->poc_contact ?? ''}}" >
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <select id="payment_terms" name="payment_terms" class="form-control select2-basic client-payment-terms" data-placeholder="Select Payment Type">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" min="0" class="form-control credit-limit-input" id="credit_limit" name="credit_limit" placeholder="Credit Limit" value="{{$client->credit_limit ?? ''}}" autocomplete="fsd">
    </div>
