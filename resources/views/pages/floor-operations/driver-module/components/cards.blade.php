        ...
        <a href="{{url('driver/service-orders')}}" class="col-sm-3 mt-3 rm-underline">
            <div class="card card-statistics">
                <div class="card-body btn-primary">
                    <h2 id="view-order-count">View Order ({{$order_count}})</h2>
                </div>
            </div>
        </a>

        <a href="{{url('driver/service-orders/pending-delivery')}}" class="col-sm-3 mt-3 rm-underline">
            <div class="card card-statistics">
                <div class="card-body btn-primary">
                    <h2>Delivery ({{$delivery_count}})</h2>
                </div>
            </div>
        </a>
